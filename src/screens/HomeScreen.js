...
const HomeScreen = ({ navigation }) => {
  ...
  const renderItem = ({ item }) => (
    <Pressable
      key={item.id}
      onPress={() => navigation.navigate('detail-screen', { productId: item?.id })}>
      <NewArrivalsCard title={item?.title} image={item?.image} price={item?.price} brand={item?.brand} />
    </Pressable>
  );
    ...
    <SafeAreaView style={styles.container}>
          ...
          <View style={{ marginTop: 24, paddingHorizontal: 20 }}>
            <View style={styles.search}>
              ...
              <TextInput placeholder="Search..." placeholderTextColor={'#666666'} style={{ paddingHorizontal: 8 }} />
            </View>
          </View>
          ...
          <View style={{ marginTop: 16 }}>
            <View
              ...
              <Pressable onPress={() => navigation.navigate('product-screen')}>
                <Text style={{ fontSize: 12, color: '#888' }}>View all</Text>
              </Pressable>
            </View>
          ...
          <View>
            <AuthenticationModel modelVisible={modelVisible} setModelVisible={setModelVisible} />
          </View>
